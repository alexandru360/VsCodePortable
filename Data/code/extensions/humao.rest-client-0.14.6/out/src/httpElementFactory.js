    ...
    static getHttpElements(line) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (var variableName in customVariables) {
                originalElements.push(new httpElement_1.HttpElement(variableName, httpElement_1.ElementType.CustomVariable, null, `Value: ${customVariables[variableName]}`, new vscode_1.SnippetString(`{{${variableName}}}`)));
            }
            ...
            if (elements.length === 0) {
                ...
                originalElements.filter(e => !e.prefix && (e.type === httpElement_1.ElementType.SystemVariable || e.type === httpElement_1.ElementType.CustomVariable)).forEach(element => {
                    elements.push(element);
                });
            }
            return elements;
