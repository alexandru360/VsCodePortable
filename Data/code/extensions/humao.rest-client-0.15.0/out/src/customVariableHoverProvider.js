        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (var [variableName, variableValue] of fileCustomVariables) {
                if (variableName === selectedVariableName) {
                    let contents = [variableValue, { language: 'http', value: `File Variable ${variableName}` }];
            ...
            for (var variableName in environmentCustomVariables) {
                if (variableName === selectedVariableName) {
                    let contents = [environmentCustomVariables[variableName], { language: 'http', value: `Environment Variable ${variableName}` }];
                    return new vscode_1.Hover(contents, wordRange);
                }
            }
            return;
