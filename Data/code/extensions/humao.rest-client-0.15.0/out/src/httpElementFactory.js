    ...
    static getHttpElements(line) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (elements.length === 0) {
                ...
                originalElements.filter(e => !e.prefix && (e.type === httpElement_1.ElementType.SystemVariable || e.type === httpElement_1.ElementType.EnvironmentCustomVariable)).forEach(element => {
                    elements.push(element);
                });
            }
            return elements;
